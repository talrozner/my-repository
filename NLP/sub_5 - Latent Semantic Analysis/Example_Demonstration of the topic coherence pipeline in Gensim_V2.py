...
#%%Load File
file_path = r"D:\DS\NLP\Seminar\Code Example\Code By Subject\sub_5 - Latent Semantic Analysis\articles_4.txt"
...
#%% Number of optimal Topics = 3 
temp_lda_model = LdaModel(corpus=corpus, id2word=dictionary, num_topics=3, iterations=1000)
